    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="table-responsive">
                ...
                <router-link to="/editorial/create" class="btn btn-primary float-end">Registrar</router-link>
                <table
                 class="table table-bordered table-hover">
                    ...
                    <tbody class="table-group-divider" id="contenido">
                        <tr v-for="editorial in editorials" :key="editorial.id_editorial">
                            ...
                            <td>
                                <router-link :to="{path:'editorial/edit/'+editorial.id_editorial}" class="btn btn-warning">
